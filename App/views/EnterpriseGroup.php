                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <p>
                                Please, fill the next forms to set the first configuration.
                            </p>

                            <form id="form" action="http://localhost:8012/ibrain2.0/private/enterpriseGroup/toDo" method="POST" class="wizard-big">
